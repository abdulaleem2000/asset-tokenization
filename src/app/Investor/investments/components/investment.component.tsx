...
export default function Investment(props: any) {
  ...
  const num = Number(props.data.tokenPrice) / 1000000000000000000;
  console.log(num);
    ...
    <main id={styles.investment}>
      ...
      <div id={styles.investmentInformation}>
        ...
        <div>
          <div>
            <p>Price:</p>
            <p>{Number(props.data.tokenPrice) / 1000000000000000000}</p>
          </div>
          <div>
            <p>Token:</p>
            <p>{Number(props.data.numberOfTokens)}</p>
          </div>
        </div>
      </div>
      <Link
        href={{
          pathname: "/Investor/view-investment",
          query: {
